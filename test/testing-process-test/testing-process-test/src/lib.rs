...
use caller_utils::testing_process::{echo_local_rpc, echo_remote_rpc}; // Import RPC functions

// FailResponse and Response (as TesterResponse) are generated by wit_bindgen in the async_test_suite! macro


mod tester_lib;

async_test_suite!(
    "testing-process-test-template-dot-os-v0",
    ...
    test_echo_local_rpc: async {
        ...
        let address: Address = ("testing-process.os", "testing-process", "testing-process", "template.os").into();
